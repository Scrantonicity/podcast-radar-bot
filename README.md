...
> 🔗 **See a live example:** a real, populated radar built with this bot —
> [browse the Notion database](https://app.notion.com/p/3844824966ba80bf98a7eae01adc03ee).
...
| Script | Purpose |
|--------|---------|
| `scripts/notion_ids.py` | Resolve the two data-source IDs from your database IDs (onboarding). |
| `scripts/transcribe_one.py` | Transcribe one episode to a text file (a sample for deriving the taxonomy). |
| `scripts/taxonomy_review.py` | Surface recurring `other` entities as new-category candidates to promote. |
...
[contributors-shield]: https://img.shields.io/github/contributors/Scrantonicity/podcast-radar-bot.svg?style=for-the-badge&v=2
[contributors-url]: https://github.com/Scrantonicity/podcast-radar-bot/graphs/contributors
[forks-shield]: https://img.shields.io/github/forks/Scrantonicity/podcast-radar-bot.svg?style=for-the-badge&v=2
[forks-url]: https://github.com/Scrantonicity/podcast-radar-bot/network/members
[stars-shield]: https://img.shields.io/github/stars/Scrantonicity/podcast-radar-bot.svg?style=for-the-badge&v=2
[stars-url]: https://github.com/Scrantonicity/podcast-radar-bot/stargazers
[issues-shield]: https://img.shields.io/github/issues/Scrantonicity/podcast-radar-bot.svg?style=for-the-badge&v=2
[issues-url]: https://github.com/Scrantonicity/podcast-radar-bot/issues
[license-shield]: https://img.shields.io/github/license/Scrantonicity/podcast-radar-bot.svg?style=for-the-badge&v=2
